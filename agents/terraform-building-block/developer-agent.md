...
1. Read and triage the GitHub issue; validate DoR — load `skills/github-cli/references/issue-triage-standards.md`
2. Take interface snapshot (`make snapshot`), classify expected semver tier
3. Create `TODO.md` from template — load `skills/ralph-build-agent/references/todo-template.md`
...
- `skills/ralph-build-agent/references/todo-template.md` — standard TODO.md structure
