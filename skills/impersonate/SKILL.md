...
This skill enables seamless integration with **agent-driven development model****agent-driven development model**. Each project uses specialized agents (e.g., `@developer-agent`, `@review-agent`, `@release-agent`, `@triage-agent`) that provide context-aware workflows, quality standards, and specialized expertise.
...
- [Agent-Driven Development Standards](#)
